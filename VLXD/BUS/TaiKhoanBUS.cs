...
namespace BUS
{
    public class TaiKhoanBUS
    {
        ...
        public List<TaiKhoan> SearchMaDangNhap(int key)
        {
            return userDAO.SearchMaUserDAO(key);
        }

        public List<TaiKhoan> SearchTenDangNhap(string key)
        {
            return userDAO.SearchTenDangNhapDAO(key);
        }
    }
}
